...
**⚠️ Educational / research-use-only PoC ⚠️**  
**Using this tool on a real Discord account will very likely result in permanent account termination.**

A collection of low-level Discord client experiments and utilities written in [Python].

**This repository exists purely for code-study, reverse-engineering discussion and security research purposes.**

## 🔥 Currently implemented / experimented-with features

- Invisible / ghost mode in voice channels
- Server / guild cloning (channels + permissions + roles + emojis + stickers)
- Message / embed / webhook spoofing utilities
...
|-------------------------------|---------------------|-----------------------------------------------------------------------------|
| Against Discord ToS            | Yes                 | Self-bots & client mods are explicitly prohibited                           |
| Can get your account banned    | Very high probability | Even one successful detection wave → permanent ban                          |
| Legal risk                     | Low–medium          | Depends on jurisdiction and actual usage (harassment, raiding, doxxing…)   |

## 🛑 Do NOT use this if

- you care about your Discord account
- you use Nitro / paid features
- you are in big public servers
- you participate in drama / raids / token logging scenes
...
[<img width="272" height="163" alt="image" src="https://github.com/user-attachments/assets/c2315a9d-d3ed-4dd0-beb8-de3a58a53a92" />](https://github.com/Archeor/ArcheorTools/blob/main/gg.gif.gif?raw=true)
